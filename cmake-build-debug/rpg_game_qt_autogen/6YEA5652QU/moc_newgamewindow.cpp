...
QT_MOC_LITERAL(2, 37, 0) // ""
    ...
    "NewGameWindow\0on_startButton_clicked\0"
    ""
};
...
void NewGameWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NewGameWindow *_t = static_cast<NewGameWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject NewGameWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NewGameWindow.data,
      qt_meta_data_NewGameWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NewGameWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NewGameWindow.stringdata0))
        return static_cast<void*>(const_cast< NewGameWindow*>(this));
