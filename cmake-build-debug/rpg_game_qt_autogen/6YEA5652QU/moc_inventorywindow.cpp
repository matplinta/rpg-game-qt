...
void InventoryWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (InventoryWindow::*_t)(Player * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InventoryWindow::sendChangedPlayer)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject InventoryWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_InventoryWindow.data,
